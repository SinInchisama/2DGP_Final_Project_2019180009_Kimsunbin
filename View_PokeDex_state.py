...
CursorY = None
Prange = None
frame,exiting = None,None

def enter():
    global CursorY,Prange,frame,exiting
    exiting = False
    CursorY,frame = 0,0
    Prange = 0
    pass
...
def draw():
    ...
    if(frame<10):
        ...
        play_state.Pokedex.image.clip_draw(176,1760,160,144,320,288,640,576)
        ...
        if(play_state.Pokedex.list[CursorY + Prange] != 0):
            Poketmon.Data.image.clip_draw(Poketmon.Poket_Data[CursorY + Prange].Pngx, Poketmon.Poket_Data[CursorY + Prange].Pngy, 56, 56, 125, 427, 224,224)
